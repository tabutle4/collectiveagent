module.exports=[93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},54799,(e,t,r)=>{t.exports=e.x("crypto",()=>require("crypto"))},60453,e=>{"use strict";var t=e.i(54799);async function r(e,r){let o=t.default.randomBytes(32),n=`${e}:${o.toString("hex")}`;return Buffer.from(n).toString("base64url")}function o(e){try{let[t]=Buffer.from(e,"base64url").toString("utf-8").split(":");if(!t)return null;return{listingId:t}}catch(e){return console.error("Error validating magic link:",e),null}}function n(e){return`https://agent.collectiverealtyco.com/seller/${e}`}async function a(e){let r=t.default.randomBytes(32),o=`${e}:${r.toString("hex")}`;return Buffer.from(o).toString("base64url")}function i(e){try{let[t]=Buffer.from(e,"base64url").toString("utf-8").split(":");if(!t)return null;return{formType:t}}catch(e){return console.error("Error validating form token:",e),null}}function s(e,t){return`https://agent.collectiverealtyco.com/forms/${t}/${e}`}e.s(["generateFormToken",()=>a,"generateMagicLink",()=>r,"getFormLinkUrl",()=>s,"getMagicLinkUrl",()=>n,"validateFormToken",()=>i,"validateMagicLink",()=>o])},34138,e=>{"use strict";var t=e.i(46245),r=e.i(60453);let o=new t.Resend(process.env.RESEND_API_KEY),n="transactions@coachingbrokeragetools.com",a="Leah Parpan - Listing & Transaction Coordinator",i="tcandcompliance@collectiverealtyco.com",s="tcandcompliance@collectiverealtyco.com";async function l(e,t,l){try{var d,c,p;let u,g=(d=l.name,c=l.email,p=l.phone,u=(0,r.getMagicLinkUrl)(e.seller_magic_link),`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body>
  ...
  `),{data:f,error:m}=await o.emails.send({from:`${a} <${n}>`,to:e.seller_email,cc:[l.email],bcc:[s],replyTo:i,subject:`Collective Realty Co. - Welcome to Weekly Listing Coordination - ${t.property_address}`,html:g});if(m)return console.error("Error sending welcome email:",m),{success:!1,error:m.message};return{success:!0,emailId:f?.id}}catch(e){return console.error("Error sending welcome email:",e),{success:!1,error:e.message}}}async function d(e,t,l,d,c,p){try{let u,g=(u=(0,r.getMagicLinkUrl)(e.seller_magic_link),`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body>
  ...
  `),{data:f,error:m}=await o.emails.send({from:`${a} <${n}>`,to:e.seller_email,cc:[l],bcc:[s],replyTo:i,subject:`Collective Realty Co. - Weekly Report - ${t.property_address} | ${d}`,html:g});if(m)return console.error("Error sending weekly report email:",m),{success:!1,error:m.message};return{success:!0,emailId:f?.id}}catch(e){return console.error("Error sending weekly report email:",e),{success:!1,error:e.message}}}async function c({to:e,subject:t,html:r,cc:s}){try{let{data:l,error:d}=await o.emails.send({from:`${a} <${n}>`,to:Array.isArray(e)?e:[e],cc:s?Array.isArray(s)?s:[s]:void 0,replyTo:i,subject:t,html:r});if(d)return console.error("Error sending email:",d),{success:!1,error:d.message};return{success:!0,emailId:l?.id}}catch(e){return console.error("Error sending email:",e),{success:!1,error:e.message}}}e.s(["sendEmail",()=>c,"sendWeeklyReportEmail",()=>d,"sendWelcomeEmail",()=>l],34138)},89808,e=>{"use strict";var t=e.i(47909),r=e.i(74017),o=e.i(96250),n=e.i(59756),a=e.i(61916),i=e.i(74677),s=e.i(69741),l=e.i(16795),d=e.i(87718),c=e.i(95169),p=e.i(47587),u=e.i(66012),g=e.i(70101),f=e.i(26937),m=e.i(10372),x=e.i(93695);e.i(20232);var h=e.i(5232),y=e.i(89171),v=e.i(89660),b=e.i(34138);async function w(e){try{let t=(0,v.createClient)(),{listing_id:r,agent_id:o,agent_name:n,agent_email:a,message:i,property_address:s}=await e.json();if(!r||!o||!i||!s)return y.NextResponse.json({error:"Missing required fields"},{status:400});let{data:l}=await t.from("listings").select("agent_id").eq("id",r).single();if(!l||l.agent_id!==o)return y.NextResponse.json({error:"Unauthorized - You can only request updates for your own listings"},{status:403});let{data:d}=await t.from("users").select("email, preferred_first_name, preferred_last_name").contains("roles",["admin"]);if(!d||0===d.length)return y.NextResponse.json({error:"No admin users found to notify"},{status:500});let c=d.map(e=>e.email).filter(Boolean);if(c.length>0)try{await (0,b.sendEmail)({to:c,subject:`Update Request: ${s}`,html:`
