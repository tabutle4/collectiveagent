...
<body>
  ...
  `),{data:m,error:f}=await n.emails.send({from:`${o} <${i}>`,to:e.seller_email,cc:[l],bcc:[s],replyTo:a,subject:`Collective Realty Co. - Weekly Report - ${t.property_address} | ${d}`,html:g});if(f)return console.error("Error sending weekly report email:",f),{success:!1,error:f.message};return{success:!0,emailId:m?.id}}catch(e){return console.error("Error sending weekly report email:",e),{success:!1,error:e.message}}}async function c({to:e,subject:t,html:r,cc:s}){try{let{data:l,error:d}=await n.emails.send({from:`${o} <${i}>`,to:Array.isArray(e)?e:[e],cc:s?Array.isArray(s)?s:[s]:void 0,replyTo:a,subject:t,html:r});if(d)return console.error("Error sending email:",d),{success:!1,error:d.message};return{success:!0,emailId:l?.id}}catch(e){return console.error("Error sending email:",e),{success:!1,error:e.message}}}e.s(["sendEmail",()=>c,"sendWeeklyReportEmail",()=>d,"sendWelcomeEmail",()=>l],34138)},37933,e=>{"use strict";var t=e.i(47909),r=e.i(74017),n=e.i(96250),i=e.i(59756),o=e.i(61916),a=e.i(74677),s=e.i(69741),l=e.i(16795),d=e.i(87718),c=e.i(95169),p=e.i(47587),u=e.i(66012),g=e.i(70101),m=e.i(26937),f=e.i(10372),y=e.i(93695);e.i(20232);var h=e.i(5232),x=e.i(89171),_=e.i(89660),v=e.i(85034),w=e.i(34999),b=e.i(34138);async function k(e){try{let t,r,n=(0,_.createClient)(),{coordination_id:i}=await e.json();if(!i)return x.NextResponse.json({error:"Coordination ID is required"},{status:400});let o=await (0,w.getCoordinationById)(i);if(!o)return x.NextResponse.json({error:"Coordination not found"},{status:404});let a=await (0,v.getListingById)(o.listing_id);if(!a)return x.NextResponse.json({error:"Listing not found"},{status:404});let s="";if(o.agent_id){let{data:e}=await n.from("users").select("email").eq("id",o.agent_id).single();e&&(s=e.email||"")}let{data:l}=await n.from("coordination_weekly_reports").select("*").eq("coordination_id",i).eq("email_sent",!1).order("week_start_date",{ascending:!1}).limit(1).single();l&&(t=l.report_file_url||void 0,r=l.report_file_url_2||void 0);let d=new Date().toLocaleDateString("en-US",{weekday:"long",month:"long",day:"numeric",year:"numeric"}),c=await (0,b.sendWeeklyReportEmail)(o,a,s,d,t,r);if(!c.success)return x.NextResponse.json({error:c.error||"Failed to send email"},{status:500});return await (0,w.updateCoordination)(i,{last_email_sent_at:new Date().toISOString(),total_emails_sent:(o.total_emails_sent||0)+1}),l&&await n.from("coordination_weekly_reports").update({email_sent:!0,email_sent_at:new Date().toISOString(),email_id:c.emailId}).eq("id",l.id),await n.from("coordination_email_history").insert({coordination_id:i,email_type:"weekly_report",recipient_email:o.seller_email,recipient_name:o.seller_name,subject:`Collective Realty Co. - Weekly Report - ${a.property_address} | ${d}`,resend_email_id:c.emailId||null,status:"sent",sent_at:new Date().toISOString(),weekly_report_id:l?.id||null}),x.NextResponse.json({success:!0,message:"Weekly report email sent successfully",emailId:c.emailId})}catch(e){return console.error("Error sending weekly report email:",e),x.NextResponse.json({error:e.message||"Failed to send weekly report email"},{status:500})}}e.s(["POST",()=>k],76836);var R=e.i(76836);let C=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/coordination/send-weekly-email/route",pathname:"/api/coordination/send-weekly-email",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/coordination/send-weekly-email/route.ts",nextConfigOutput:"",userland:R}),{workAsyncStorage:E,workUnitAsyncStorage:S,serverHooks:T}=C;function A(){return(0,n.patchFetch)({workAsyncStorage:E,workUnitAsyncStorage:S})}async function $(e,t,n){C.isDev&&(0,i.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let x="/api/coordination/send-weekly-email/route";x=x.replace(/\/index$/,"")||"/";let _=await C.prepare(e,t,{srcPage:x,multiZoneDraftMode:!1});if(!_)return t.statusCode=400,t.end("Bad Request"),null==n.waitUntil||n.waitUntil.call(n,Promise.resolve()),null;let{buildId:v,params:w,nextConfig:b,parsedUrl:k,isDraftMode:R,prerenderManifest:E,routerServerContext:S,isOnDemandRevalidate:T,revalidateOnlyGenerated:A,resolvedPathname:$,clientReferenceManifest:q,serverActionsManifest:I}=_,L=(0,s.normalizeAppPath)(x),P=!!(E.dynamicRoutes[L]||E.routes[$]),D=async()=>((null==S?void 0:S.render404)?await S.render404(e,t,k,!1):t.end("This page could not be found"),null);if(P&&!R){let e=!!E.routes[$],t=E.dynamicRoutes[L];if(t&&!1===t.fallback&&!e){if(b.experimental.adapterPath)return await D();throw new y.NoFallbackError}}let O=null;!P||C.isDev||R||(O="/index"===(O=$)?"/":O);let j=!0===C.isDev||!P,N=P&&!j;I&&q&&(0,a.setManifestsSingleton)({page:x,clientReferenceManifest:q,serverActionsManifest:I});let M=e.method||"GET",U=(0,o.getTracer)(),W=U.getActiveScopeSpan(),H={params:w,prerenderManifest:E,renderOpts:{experimental:{authInterrupts:!!b.experimental.authInterrupts},cacheComponents:!!b.cacheComponents,supportsDynamicResponse:j,incrementalCache:(0,i.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:b.cacheLife,waitUntil:n.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,n,i)=>C.onRequestError(e,t,n,i,S)},sharedContext:{buildId:v}},z=new l.NodeNextRequest(e),B=new l.NodeNextResponse(t),F=d.NextRequestAdapter.fromNodeNextRequest(z,(0,d.signalFromNodeResponse)(t));try{let a=async e=>C.handle(F,H).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=U.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let n=r.get("next.route");if(n){let t=`${M} ${n}`;e.setAttributes({"next.route":n,"http.route":n,"next.span_name":t}),e.updateName(t)}else e.updateName(`${M} ${x}`)}),s=!!(0,i.getRequestMeta)(e,"minimalMode"),l=async i=>{var o,l;let d=async({previousCacheEntry:r})=>{try{if(!s&&T&&A&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let o=await a(i);e.fetchMetrics=H.renderOpts.fetchMetrics;let l=H.renderOpts.pendingWaitUntil;l&&n.waitUntil&&(n.waitUntil(l),l=void 0);let d=H.renderOpts.collectedTags;if(!P)return await (0,u.sendResponse)(z,B,o,H.renderOpts.pendingWaitUntil),null;{let e=await o.blob(),t=(0,g.toNodeOutgoingHttpHeaders)(o.headers);d&&(t[f.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==H.renderOpts.collectedRevalidate&&!(H.renderOpts.collectedRevalidate>=f.INFINITE_CACHE)&&H.renderOpts.collectedRevalidate,n=void 0===H.renderOpts.collectedExpire||H.renderOpts.collectedExpire>=f.INFINITE_CACHE?void 0:H.renderOpts.collectedExpire;return{value:{kind:h.CachedRouteKind.APP_ROUTE,status:o.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:n}}}}catch(t){throw(null==r?void 0:r.isStale)&&await C.onRequestError(e,t,{routerKind:"App Router",routePath:x,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:N,isOnDemandRevalidate:T})},!1,S),t}},c=await C.handleResponse({req:e,nextConfig:b,cacheKey:O,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:E,isRoutePPREnabled:!1,isOnDemandRevalidate:T,revalidateOnlyGenerated:A,responseGenerator:d,waitUntil:n.waitUntil,isMinimalMode:s});if(!P)return null;if((null==c||null==(o=c.value)?void 0:o.kind)!==h.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(l=c.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||t.setHeader("x-nextjs-cache",T?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),R&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let y=(0,g.fromNodeOutgoingHttpHeaders)(c.value.headers);return s&&P||y.delete(f.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||y.get("Cache-Control")||y.set("Cache-Control",(0,m.getCacheControlHeader)(c.cacheControl)),await (0,u.sendResponse)(z,B,new Response(c.value.body,{headers:y,status:c.value.status||200})),null};W?await l(W):await U.withPropagatedContext(e.headers,()=>U.trace(c.BaseServerSpan.handleRequest,{spanName:`${M} ${x}`,kind:o.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},l))}catch(t){if(t instanceof y.NoFallbackError||await C.onRequestError(e,t,{routerKind:"App Router",routePath:L,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:N,isOnDemandRevalidate:T})},!1,S),P)throw t;return await (0,u.sendResponse)(z,B,new Response(null,{status:500})),null}}e.s(["handler",()=>$,"patchFetch",()=>A,"routeModule",()=>C,"serverHooks",()=>T,"workAsyncStorage",()=>E,"workUnitAsyncStorage",()=>S],37933)}];
