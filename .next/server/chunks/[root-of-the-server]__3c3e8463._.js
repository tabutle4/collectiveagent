...
<body>
  ...
  `),f={from:`${i} <${a}>`,to:e.seller_email,cc:[l],bcc:[s],replyTo:o,subject:`Collective Realty Co. - Weekly Report - ${t.property_address} | ${d}`,html:m};u&&(f.schedule=u.toISOString());let{data:_,error:y}=await n.emails.send(f);if(y)return console.error("Error sending weekly report email:",y),{success:!1,error:y.message};return{success:!0,emailId:_?.id}}catch(e){return console.error("Error sending weekly report email:",e),{success:!1,error:e.message}}}async function c({to:e,subject:t,html:r,cc:s}){try{let{data:l,error:d}=await n.emails.send({from:`${i} <${a}>`,to:Array.isArray(e)?e:[e],cc:s?Array.isArray(s)?s:[s]:void 0,replyTo:o,subject:t,html:r});if(d)return console.error("Error sending email:",d),{success:!1,error:d.message};return{success:!0,emailId:l?.id}}catch(e){return console.error("Error sending email:",e),{success:!1,error:e.message}}}e.s(["sendEmail",()=>c,"sendWeeklyReportEmail",()=>d,"sendWelcomeEmail",()=>l],34138)},37933,e=>{"use strict";var t=e.i(47909),r=e.i(74017),n=e.i(96250),a=e.i(59756),i=e.i(61916),o=e.i(74677),s=e.i(69741),l=e.i(16795),d=e.i(87718),c=e.i(95169),p=e.i(47587),u=e.i(66012),g=e.i(70101),m=e.i(26937),f=e.i(10372),_=e.i(93695);e.i(20232);var y=e.i(5232),h=e.i(89171),x=e.i(89660),v=e.i(85034),w=e.i(34999),b=e.i(34138);async function k(e){try{let t,r,n=(0,x.createClient)(),{coordination_id:a}=await e.json();if(!a)return h.NextResponse.json({error:"Coordination ID is required"},{status:400});let i=await (0,w.getCoordinationById)(a);if(!i)return h.NextResponse.json({error:"Coordination not found"},{status:404});let o=await (0,v.getListingById)(i.listing_id);if(!o)return h.NextResponse.json({error:"Listing not found"},{status:404});let s="";if(i.agent_id){let{data:e}=await n.from("users").select("email").eq("id",i.agent_id).single();e&&(s=e.email||"")}let{data:l}=await n.from("coordination_weekly_reports").select("*").eq("coordination_id",a).eq("email_sent",!1).order("week_start_date",{ascending:!1}).limit(1).single();l&&(t=l.report_file_url||void 0,r=l.report_file_url_2||void 0);let d=new Date().toLocaleDateString("en-US",{weekday:"long",month:"long",day:"numeric",year:"numeric"}),c=await (0,b.sendWeeklyReportEmail)(i,o,s,d,t,r);if(!c.success)return h.NextResponse.json({error:c.error||"Failed to send email"},{status:500});return await (0,w.updateCoordination)(a,{last_email_sent_at:new Date().toISOString(),total_emails_sent:(i.total_emails_sent||0)+1}),l&&await n.from("coordination_weekly_reports").update({email_sent:!0,email_sent_at:new Date().toISOString(),email_id:c.emailId}).eq("id",l.id),await n.from("coordination_email_history").insert({coordination_id:a,email_type:"weekly_report",recipient_email:i.seller_email,recipient_name:i.seller_name,subject:`Collective Realty Co. - Weekly Report - ${o.property_address} | ${d}`,resend_email_id:c.emailId||null,status:"sent",sent_at:new Date().toISOString(),weekly_report_id:l?.id||null}),h.NextResponse.json({success:!0,message:"Weekly report email sent successfully",emailId:c.emailId})}catch(e){return console.error("Error sending weekly report email:",e),h.NextResponse.json({error:e.message||"Failed to send weekly report email"},{status:500})}}e.s(["POST",()=>k],76836);var R=e.i(76836);let C=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/coordination/send-weekly-email/route",pathname:"/api/coordination/send-weekly-email",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/coordination/send-weekly-email/route.ts",nextConfigOutput:"",userland:R}),{workAsyncStorage:E,workUnitAsyncStorage:S,serverHooks:$}=C;function T(){return(0,n.patchFetch)({workAsyncStorage:E,workUnitAsyncStorage:S})}async function A(e,t,n){C.isDev&&(0,a.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let h="/api/coordination/send-weekly-email/route";h=h.replace(/\/index$/,"")||"/";let x=await C.prepare(e,t,{srcPage:h,multiZoneDraftMode:!1});if(!x)return t.statusCode=400,t.end("Bad Request"),null==n.waitUntil||n.waitUntil.call(n,Promise.resolve()),null;let{buildId:v,params:w,nextConfig:b,parsedUrl:k,isDraftMode:R,prerenderManifest:E,routerServerContext:S,isOnDemandRevalidate:$,revalidateOnlyGenerated:T,resolvedPathname:A,clientReferenceManifest:q,serverActionsManifest:I}=x,L=(0,s.normalizeAppPath)(h),D=!!(E.dynamicRoutes[L]||E.routes[A]),P=async()=>((null==S?void 0:S.render404)?await S.render404(e,t,k,!1):t.end("This page could not be found"),null);if(D&&!R){let e=!!E.routes[A],t=E.dynamicRoutes[L];if(t&&!1===t.fallback&&!e){if(b.experimental.adapterPath)return await P();throw new _.NoFallbackError}}let O=null;!D||C.isDev||R||(O="/index"===(O=A)?"/":O);let N=!0===C.isDev||!D,j=D&&!N;I&&q&&(0,o.setManifestsSingleton)({page:h,clientReferenceManifest:q,serverActionsManifest:I});let M=e.method||"GET",U=(0,i.getTracer)(),W=U.getActiveScopeSpan(),H={params:w,prerenderManifest:E,renderOpts:{experimental:{authInterrupts:!!b.experimental.authInterrupts},cacheComponents:!!b.cacheComponents,supportsDynamicResponse:N,incrementalCache:(0,a.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:b.cacheLife,waitUntil:n.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,n,a)=>C.onRequestError(e,t,n,a,S)},sharedContext:{buildId:v}},z=new l.NodeNextRequest(e),B=new l.NodeNextResponse(t),F=d.NextRequestAdapter.fromNodeNextRequest(z,(0,d.signalFromNodeResponse)(t));try{let o=async e=>C.handle(F,H).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=U.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let n=r.get("next.route");if(n){let t=`${M} ${n}`;e.setAttributes({"next.route":n,"http.route":n,"next.span_name":t}),e.updateName(t)}else e.updateName(`${M} ${h}`)}),s=!!(0,a.getRequestMeta)(e,"minimalMode"),l=async a=>{var i,l;let d=async({previousCacheEntry:r})=>{try{if(!s&&$&&T&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let i=await o(a);e.fetchMetrics=H.renderOpts.fetchMetrics;let l=H.renderOpts.pendingWaitUntil;l&&n.waitUntil&&(n.waitUntil(l),l=void 0);let d=H.renderOpts.collectedTags;if(!D)return await (0,u.sendResponse)(z,B,i,H.renderOpts.pendingWaitUntil),null;{let e=await i.blob(),t=(0,g.toNodeOutgoingHttpHeaders)(i.headers);d&&(t[f.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==H.renderOpts.collectedRevalidate&&!(H.renderOpts.collectedRevalidate>=f.INFINITE_CACHE)&&H.renderOpts.collectedRevalidate,n=void 0===H.renderOpts.collectedExpire||H.renderOpts.collectedExpire>=f.INFINITE_CACHE?void 0:H.renderOpts.collectedExpire;return{value:{kind:y.CachedRouteKind.APP_ROUTE,status:i.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:n}}}}catch(t){throw(null==r?void 0:r.isStale)&&await C.onRequestError(e,t,{routerKind:"App Router",routePath:h,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:j,isOnDemandRevalidate:$})},!1,S),t}},c=await C.handleResponse({req:e,nextConfig:b,cacheKey:O,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:E,isRoutePPREnabled:!1,isOnDemandRevalidate:$,revalidateOnlyGenerated:T,responseGenerator:d,waitUntil:n.waitUntil,isMinimalMode:s});if(!D)return null;if((null==c||null==(i=c.value)?void 0:i.kind)!==y.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(l=c.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||t.setHeader("x-nextjs-cache",$?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),R&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let _=(0,g.fromNodeOutgoingHttpHeaders)(c.value.headers);return s&&D||_.delete(f.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||_.get("Cache-Control")||_.set("Cache-Control",(0,m.getCacheControlHeader)(c.cacheControl)),await (0,u.sendResponse)(z,B,new Response(c.value.body,{headers:_,status:c.value.status||200})),null};W?await l(W):await U.withPropagatedContext(e.headers,()=>U.trace(c.BaseServerSpan.handleRequest,{spanName:`${M} ${h}`,kind:i.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},l))}catch(t){if(t instanceof _.NoFallbackError||await C.onRequestError(e,t,{routerKind:"App Router",routePath:L,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:j,isOnDemandRevalidate:$})},!1,S),D)throw t;return await (0,u.sendResponse)(z,B,new Response(null,{status:500})),null}}e.s(["handler",()=>A,"patchFetch",()=>T,"routeModule",()=>C,"serverHooks",()=>$,"workAsyncStorage",()=>E,"workUnitAsyncStorage",()=>S],37933)}];
