module.exports=[93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},67652,e=>{"use strict";var t=e.i(87464);let r=(0,t.createClient)("https://zuhqqtfnyjlvbpcprdhf.supabase.co","eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp1aHFxdGZueWpsdmJwY3ByZGhmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjEyNTUyMjAsImV4cCI6MjA3NjgzMTIyMH0.EP5nnbIpWoOVQ7jUrjnkuEJsGAmLY1oVLpS4pnlyjj4"),o=process.env.SUPABASE_SERVICE_ROLE_KEY?(0,t.createClient)("https://zuhqqtfnyjlvbpcprdhf.supabase.co",process.env.SUPABASE_SERVICE_ROLE_KEY):r;e.s(["supabase",0,r,"supabaseAdmin",0,o])},133,e=>{"use strict";var t=e.i(46245);if(!process.env.RESEND_API_KEY)throw Error("Missing env.RESEND_API_KEY");let r=new t.Resend(process.env.RESEND_API_KEY),o="Collective Support <support@coachingbrokeragetools.com>",n="Collective Notifications <notifications@coachingbrokeragetools.com>",a="office@collectiverealtyco.com";async function i(e){let t=p({greeting:`Hi ${e.preferred_first_name},`,content:`
    ...
    `});return r.emails.send({from:"Collective Realty Co. <onboarding@coachingbrokeragetools.com>",to:e.email,cc:a,subject:"Next Steps with Collective Realty Co.",html:t})}async function s(e,t){let o=p({greeting:"New Prospective Agent Submission",content:`
    ...
    `}),i=[a,...e];return r.emails.send({from:n,to:i,subject:`New Prospective Agent: ${t.preferred_first_name} ${t.preferred_last_name}`,html:o})}async function l(e,t,n){let i=`http://localhost:3000/auth/reset-password?token=${t}`,s=p({greeting:`Hi ${n},`,content:`
    ...
    `});return r.emails.send({from:o,to:e,cc:a,subject:"Reset Your Password - Collective Realty Co.",html:s})}function p({greeting:e,content:t,darkSection:r,closing:o}){return`
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  `}async function c({message:e,userName:t,userEmail:n}){let a=p({greeting:`Hello ${t.split(" ")[0]},`,content:`
    ...
    `});await r.emails.send({from:o,to:n,cc:"office@collectiverealtyco.com",subject:"Support Request Received",html:a})}async function d({formName:e,formType:t,submissionData:o,responseId:a,notificationEmail:i}){let s=new Date().toLocaleString("en-US",{dateStyle:"long",timeStyle:"short"}),l=Object.entries(o).filter(([e])=>!["id","created_at","updated_at","formType","form_type","listing_id","user_id","agent_id"].includes(e)).map(([e,t])=>{let r=e.split("_").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "),o=null==t||""===t?"N/A":"boolean"==typeof t?t?"Yes":"No":"object"==typeof t?JSON.stringify(t,null,2):String(t);return`
        <div style="margin-bottom: 16px; padding-bottom: 16px; border-bottom: 1px solid #e0e0e0;">
          <p style="margin: 0 0 4px 0; font-weight: 600; color: #000; font-size: 14px;">${r}</p>
          <p style="margin: 0; color: #666; font-size: 14px; white-space: pre-wrap;">${o}</p>
        </div>
    ...
    `});return r.emails.send({from:n,to:i,subject:`New ${e} Submission`,html:d})}e.s(["sendAdminProspectNotification",()=>s,"sendContactEmail",()=>c,"sendFormSubmissionNotification",()=>d,"sendPasswordResetEmail",()=>l,"sendProspectWelcomeEmail",()=>i])},56148,e=>{"use strict";var t=e.i(47909),r=e.i(74017),o=e.i(96250),n=e.i(59756),a=e.i(61916),i=e.i(74677),s=e.i(69741),l=e.i(16795),p=e.i(87718),c=e.i(95169),d=e.i(47587),g=e.i(66012),m=e.i(70101),u=e.i(26937),f=e.i(10372),h=e.i(93695);e.i(20232);var x=e.i(5232),y=e.i(89171),b=e.i(67652),v=e.i(133);async function w(e){try{let t=await e.json();for(let e of["first_name","last_name","preferred_first_name","preferred_last_name","email","phone","location","mls_choice","association_status","expectations","accountability","lead_generation","additional_info","how_heard"])if(!t[e])return y.NextResponse.json({error:`${e} is required`},{status:400});let r=t.phone.replace(/\D/g,"");if(10!==r.length)return y.NextResponse.json({error:"Phone number must be exactly 10 digits"},{status:400});let{data:o}=await b.supabase.from("users").select("id").eq("email",t.email.toLowerCase()).single();if(o)return y.NextResponse.json({error:"This email is already registered in our system"},{status:409});let{data:n,error:a}=await b.supabase.from("users").insert({email:t.email.toLowerCase(),password_hash:"",first_name:t.first_name,last_name:t.last_name,preferred_first_name:t.preferred_first_name,preferred_last_name:t.preferred_last_name,status:"prospect",is_active:!1,roles:[],phone:r,location:t.location,instagram_handle:t.instagram_handle||null,mls_choice:t.mls_choice,association_status_on_join:t.association_status,previous_brokerage:t.previous_brokerage||null,expectations:t.expectations,accountability:t.accountability,lead_generation:t.lead_generation,additional_info:t.additional_info,how_heard:t.how_heard,how_heard_other:t.how_heard_other||null,referring_agent:t.referring_agent||null,joining_team:t.joining_team||null,prospect_status:"new"}).select().single();if(a)throw console.error("Insert error:",a),a;try{await (0,v.sendProspectWelcomeEmail)({preferred_first_name:n.preferred_first_name,email:n.email})}catch(e){console.error("Error sending prospect email:",e)}let{data:i}=await b.supabase.from("users").select("email").contains("roles",["admin"]).eq("is_active",!0),s=i?.map(e=>e.email)||[];try{await (0,v.sendAdminProspectNotification)(s,n)}catch(e){console.error("Error sending admin notification:",e)}return y.NextResponse.json({message:"Prospect submitted successfully",prospect:{id:n.id,preferred_first_name:n.preferred_first_name,email:n.email}})}catch(e){return console.error("Prospect submission error:",e),y.NextResponse.json({error:"An error occurred while submitting your information"},{status:500})}}async function _(e){try{let{data:e,error:t}=await b.supabase.from("users").select("*").eq("status","prospect").order("created_at",{ascending:!1});if(t)throw t;return y.NextResponse.json({prospects:e})}catch(e){return console.error("Get prospects error:",e),y.NextResponse.json({error:"An error occurred while fetching prospects"},{status:500})}}e.s(["GET",()=>_,"POST",()=>w],67882);var R=e.i(67882);let C=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/prospects/route",pathname:"/api/prospects",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/prospects/route.ts",nextConfigOutput:"",userland:R}),{workAsyncStorage:E,workUnitAsyncStorage:k,serverHooks:A}=C;function S(){return(0,o.patchFetch)({workAsyncStorage:E,workUnitAsyncStorage:k})}async function N(e,t,o){C.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let y="/api/prospects/route";y=y.replace(/\/index$/,"")||"/";let b=await C.prepare(e,t,{srcPage:y,multiZoneDraftMode:!1});if(!b)return t.statusCode=400,t.end("Bad Request"),null==o.waitUntil||o.waitUntil.call(o,Promise.resolve()),null;let{buildId:v,params:w,nextConfig:_,parsedUrl:R,isDraftMode:E,prerenderManifest:k,routerServerContext:A,isOnDemandRevalidate:S,revalidateOnlyGenerated:N,resolvedPathname:$,clientReferenceManifest:P,serverActionsManifest:j}=b,I=(0,s.normalizeAppPath)(y),O=!!(k.dynamicRoutes[I]||k.routes[$]),T=async()=>((null==A?void 0:A.render404)?await A.render404(e,t,R,!1):t.end("This page could not be found"),null);if(O&&!E){let e=!!k.routes[$],t=k.dynamicRoutes[I];if(t&&!1===t.fallback&&!e){if(_.experimental.adapterPath)return await T();throw new h.NoFallbackError}}let q=null;!O||C.isDev||E||(q="/index"===(q=$)?"/":q);let M=!0===C.isDev||!O,U=O&&!M;j&&P&&(0,i.setManifestsSingleton)({page:y,clientReferenceManifest:P,serverActionsManifest:j});let z=e.method||"GET",H=(0,a.getTracer)(),D=H.getActiveScopeSpan(),F={params:w,prerenderManifest:k,renderOpts:{experimental:{authInterrupts:!!_.experimental.authInterrupts},cacheComponents:!!_.cacheComponents,supportsDynamicResponse:M,incrementalCache:(0,n.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:_.cacheLife,waitUntil:o.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,o,n)=>C.onRequestError(e,t,o,n,A)},sharedContext:{buildId:v}},L=new l.NodeNextRequest(e),J=new l.NodeNextResponse(t),Y=p.NextRequestAdapter.fromNodeNextRequest(L,(0,p.signalFromNodeResponse)(t));try{let i=async e=>C.handle(Y,F).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=H.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let o=r.get("next.route");if(o){let t=`${z} ${o}`;e.setAttributes({"next.route":o,"http.route":o,"next.span_name":t}),e.updateName(t)}else e.updateName(`${z} ${y}`)}),s=!!(0,n.getRequestMeta)(e,"minimalMode"),l=async n=>{var a,l;let p=async({previousCacheEntry:r})=>{try{if(!s&&S&&N&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let a=await i(n);e.fetchMetrics=F.renderOpts.fetchMetrics;let l=F.renderOpts.pendingWaitUntil;l&&o.waitUntil&&(o.waitUntil(l),l=void 0);let p=F.renderOpts.collectedTags;if(!O)return await (0,g.sendResponse)(L,J,a,F.renderOpts.pendingWaitUntil),null;{let e=await a.blob(),t=(0,m.toNodeOutgoingHttpHeaders)(a.headers);p&&(t[f.NEXT_CACHE_TAGS_HEADER]=p),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==F.renderOpts.collectedRevalidate&&!(F.renderOpts.collectedRevalidate>=f.INFINITE_CACHE)&&F.renderOpts.collectedRevalidate,o=void 0===F.renderOpts.collectedExpire||F.renderOpts.collectedExpire>=f.INFINITE_CACHE?void 0:F.renderOpts.collectedExpire;return{value:{kind:x.CachedRouteKind.APP_ROUTE,status:a.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:o}}}}catch(t){throw(null==r?void 0:r.isStale)&&await C.onRequestError(e,t,{routerKind:"App Router",routePath:y,routeType:"route",revalidateReason:(0,d.getRevalidateReason)({isStaticGeneration:U,isOnDemandRevalidate:S})},!1,A),t}},c=await C.handleResponse({req:e,nextConfig:_,cacheKey:q,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:k,isRoutePPREnabled:!1,isOnDemandRevalidate:S,revalidateOnlyGenerated:N,responseGenerator:p,waitUntil:o.waitUntil,isMinimalMode:s});if(!O)return null;if((null==c||null==(a=c.value)?void 0:a.kind)!==x.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(l=c.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||t.setHeader("x-nextjs-cache",S?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),E&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let h=(0,m.fromNodeOutgoingHttpHeaders)(c.value.headers);return s&&O||h.delete(f.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||h.get("Cache-Control")||h.set("Cache-Control",(0,u.getCacheControlHeader)(c.cacheControl)),await (0,g.sendResponse)(L,J,new Response(c.value.body,{headers:h,status:c.value.status||200})),null};D?await l(D):await H.withPropagatedContext(e.headers,()=>H.trace(c.BaseServerSpan.handleRequest,{spanName:`${z} ${y}`,kind:a.SpanKind.SERVER,attributes:{"http.method":z,"http.target":e.url}},l))}catch(t){if(t instanceof h.NoFallbackError||await C.onRequestError(e,t,{routerKind:"App Router",routePath:I,routeType:"route",revalidateReason:(0,d.getRevalidateReason)({isStaticGeneration:U,isOnDemandRevalidate:S})},!1,A),O)throw t;return await (0,g.sendResponse)(L,J,new Response(null,{status:500})),null}}e.s(["handler",()=>N,"patchFetch",()=>S,"routeModule",()=>C,"serverHooks",()=>A,"workAsyncStorage",()=>E,"workUnitAsyncStorage",()=>k],56148)}];
