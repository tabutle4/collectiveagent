module.exports=[93695,(e,t,o)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},70406,(e,t,o)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},18622,(e,t,o)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,o)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,o)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,o)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},133,e=>{"use strict";var t=e.i(46245);if(!process.env.RESEND_API_KEY)throw Error("Missing env.RESEND_API_KEY");let o=new t.Resend(process.env.RESEND_API_KEY),r="Collective Support <support@coachingbrokeragetools.com>",n="Collective Notifications <notifications@coachingbrokeragetools.com>",a="office@collectiverealtyco.com";async function i(e){let t=p({greeting:`Hi ${e.preferred_first_name},`,content:`
    ...
    `});return o.emails.send({from:"Collective Realty Co. <onboarding@coachingbrokeragetools.com>",to:e.email,cc:a,subject:"Next Steps with Collective Realty Co.",html:t})}async function s(e,t){let r=p({greeting:"New Prospective Agent Submission",content:`
    ...
    `}),i=[a,...e];return o.emails.send({from:n,to:i,subject:`New Prospective Agent: ${t.preferred_first_name} ${t.preferred_last_name}`,html:r})}async function l(e,t,n){let i=`http://localhost:3000/auth/reset-password?token=${t}`,s=p({greeting:`Hi ${n},`,content:`
    ...
    `});return o.emails.send({from:r,to:e,cc:a,subject:"Reset Your Password - Collective Realty Co.",html:s})}function p({greeting:e,content:t,darkSection:o,closing:r}){return`
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  `}async function c({message:e,userName:t,userEmail:n}){let a=p({greeting:`Hello ${t.split(" ")[0]},`,content:`
    ...
    `});await o.emails.send({from:r,to:n,cc:"office@collectiverealtyco.com",subject:"Support Request Received",html:a})}async function d({formName:e,formType:t,submissionData:r,responseId:a,notificationEmail:i}){let s=new Date().toLocaleString("en-US",{dateStyle:"long",timeStyle:"short"}),l=Object.entries(r).filter(([e])=>!["id","created_at","updated_at","formType","form_type","listing_id","user_id","agent_id"].includes(e)).map(([e,t])=>{let o=e.split("_").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "),r=null==t||""===t?"N/A":"boolean"==typeof t?t?"Yes":"No":"object"==typeof t?JSON.stringify(t,null,2):String(t);return`
        <div style="margin-bottom: 16px; padding-bottom: 16px; border-bottom: 1px solid #e0e0e0;">
          <p style="margin: 0 0 4px 0; font-weight: 600; color: #000; font-size: 14px;">${o}</p>
          <p style="margin: 0; color: #666; font-size: 14px; white-space: pre-wrap;">${r}</p>
        </div>
      `}).join(""),c=a?`http://localhost:3000/admin/form-responses?tab=${"pre-listing"===t?"pre-listing":"just-listed"===t?"just-listed":"prospects"}`:null,d=p({greeting:"New Form Submission",content:`
      <p class="intro-text">A new submission has been received for <strong>${e}</strong>.</p>
      
      <div class="section-box">
        <h3 style="margin-top: 0; color: #000; margin-bottom: 20px;">SUBMISSION DETAILS</h3>
        <p style="margin: 8px 0; color: #666;"><strong>Form:</strong> ${e}</p>
        <p style="margin: 8px 0; color: #666;"><strong>Submitted:</strong> ${s}</p>
      ...
      ${c?`
        <div style="text-align: center; margin: 30px 0;">
          <a href="${c}" class="btn btn-black">View Response in Dashboard</a>
        </div>
      `:""}
    `,closing:`
      <p style="text-align: center; color: #666; font-size: 14px; font-style: italic;">Collective Realty Co. Form Notification</p>
    `});return o.emails.send({from:n,to:i,subject:`New ${e} Submission`,html:d})}e.s(["sendAdminProspectNotification",()=>s,"sendContactEmail",()=>c,"sendFormSubmissionNotification",()=>d,"sendPasswordResetEmail",()=>l,"sendProspectWelcomeEmail",()=>i])},10044,e=>{"use strict";var t=e.i(47909),o=e.i(74017),r=e.i(96250),n=e.i(59756),a=e.i(61916),i=e.i(74677),s=e.i(69741),l=e.i(16795),p=e.i(87718),c=e.i(95169),d=e.i(47587),g=e.i(66012),u=e.i(70101),m=e.i(26937),f=e.i(10372),x=e.i(93695);e.i(20232);var h=e.i(5232),y=e.i(89171),b=e.i(133);async function v(e){try{let{message:t,userName:o,userEmail:r}=await e.json();if(!t||!o||!r)return y.NextResponse.json({error:"Missing required fields"},{status:400});return await (0,b.sendContactEmail)({message:t,userName:o,userEmail:r}),y.NextResponse.json({success:!0})}catch(e){return console.error("Contact form error:",e),y.NextResponse.json({error:"Failed to send message"},{status:500})}}e.s(["POST",()=>v],91242);var w=e.i(91242);let R=new t.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/contact/route",pathname:"/api/contact",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/contact/route.ts",nextConfigOutput:"",userland:w}),{workAsyncStorage:C,workUnitAsyncStorage:k,serverHooks:_}=R;function E(){return(0,r.patchFetch)({workAsyncStorage:C,workUnitAsyncStorage:k})}async function A(e,t,r){R.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let y="/api/contact/route";y=y.replace(/\/index$/,"")||"/";let b=await R.prepare(e,t,{srcPage:y,multiZoneDraftMode:!1});if(!b)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:v,params:w,nextConfig:C,parsedUrl:k,isDraftMode:_,prerenderManifest:E,routerServerContext:A,isOnDemandRevalidate:S,revalidateOnlyGenerated:N,resolvedPathname:$,clientReferenceManifest:P,serverActionsManifest:T}=b,O=(0,s.normalizeAppPath)(y),j=!!(E.dynamicRoutes[O]||E.routes[$]),I=async()=>((null==A?void 0:A.render404)?await A.render404(e,t,k,!1):t.end("This page could not be found"),null);if(j&&!_){let e=!!E.routes[$],t=E.dynamicRoutes[O];if(t&&!1===t.fallback&&!e){if(C.experimental.adapterPath)return await I();throw new x.NoFallbackError}}let M=null;!j||R.isDev||_||(M="/index"===(M=$)?"/":M);let q=!0===R.isDev||!j,U=j&&!q;T&&P&&(0,i.setManifestsSingleton)({page:y,clientReferenceManifest:P,serverActionsManifest:T});let z=e.method||"GET",D=(0,a.getTracer)(),H=D.getActiveScopeSpan(),F={params:w,prerenderManifest:E,renderOpts:{experimental:{authInterrupts:!!C.experimental.authInterrupts},cacheComponents:!!C.cacheComponents,supportsDynamicResponse:q,incrementalCache:(0,n.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:C.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,o,r,n)=>R.onRequestError(e,t,r,n,A)},sharedContext:{buildId:v}},L=new l.NodeNextRequest(e),K=new l.NodeNextResponse(t),W=p.NextRequestAdapter.fromNodeNextRequest(L,(0,p.signalFromNodeResponse)(t));try{let i=async e=>R.handle(W,F).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let o=D.getRootSpanAttributes();if(!o)return;if(o.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${o.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=o.get("next.route");if(r){let t=`${z} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t)}else e.updateName(`${z} ${y}`)}),s=!!(0,n.getRequestMeta)(e,"minimalMode"),l=async n=>{var a,l;let p=async({previousCacheEntry:o})=>{try{if(!s&&S&&N&&!o)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let a=await i(n);e.fetchMetrics=F.renderOpts.fetchMetrics;let l=F.renderOpts.pendingWaitUntil;l&&r.waitUntil&&(r.waitUntil(l),l=void 0);let p=F.renderOpts.collectedTags;if(!j)return await (0,g.sendResponse)(L,K,a,F.renderOpts.pendingWaitUntil),null;{let e=await a.blob(),t=(0,u.toNodeOutgoingHttpHeaders)(a.headers);p&&(t[f.NEXT_CACHE_TAGS_HEADER]=p),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let o=void 0!==F.renderOpts.collectedRevalidate&&!(F.renderOpts.collectedRevalidate>=f.INFINITE_CACHE)&&F.renderOpts.collectedRevalidate,r=void 0===F.renderOpts.collectedExpire||F.renderOpts.collectedExpire>=f.INFINITE_CACHE?void 0:F.renderOpts.collectedExpire;return{value:{kind:h.CachedRouteKind.APP_ROUTE,status:a.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:o,expire:r}}}}catch(t){throw(null==o?void 0:o.isStale)&&await R.onRequestError(e,t,{routerKind:"App Router",routePath:y,routeType:"route",revalidateReason:(0,d.getRevalidateReason)({isStaticGeneration:U,isOnDemandRevalidate:S})},!1,A),t}},c=await R.handleResponse({req:e,nextConfig:C,cacheKey:M,routeKind:o.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:E,isRoutePPREnabled:!1,isOnDemandRevalidate:S,revalidateOnlyGenerated:N,responseGenerator:p,waitUntil:r.waitUntil,isMinimalMode:s});if(!j)return null;if((null==c||null==(a=c.value)?void 0:a.kind)!==h.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(l=c.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||t.setHeader("x-nextjs-cache",S?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),_&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let x=(0,u.fromNodeOutgoingHttpHeaders)(c.value.headers);return s&&j||x.delete(f.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||x.get("Cache-Control")||x.set("Cache-Control",(0,m.getCacheControlHeader)(c.cacheControl)),await (0,g.sendResponse)(L,K,new Response(c.value.body,{headers:x,status:c.value.status||200})),null};H?await l(H):await D.withPropagatedContext(e.headers,()=>D.trace(c.BaseServerSpan.handleRequest,{spanName:`${z} ${y}`,kind:a.SpanKind.SERVER,attributes:{"http.method":z,"http.target":e.url}},l))}catch(t){if(t instanceof x.NoFallbackError||await R.onRequestError(e,t,{routerKind:"App Router",routePath:O,routeType:"route",revalidateReason:(0,d.getRevalidateReason)({isStaticGeneration:U,isOnDemandRevalidate:S})},!1,A),j)throw t;return await (0,g.sendResponse)(L,K,new Response(null,{status:500})),null}}e.s(["handler",()=>A,"patchFetch",()=>E,"routeModule",()=>R,"serverHooks",()=>_,"workAsyncStorage",()=>C,"workUnitAsyncStorage",()=>k],10044)}];
