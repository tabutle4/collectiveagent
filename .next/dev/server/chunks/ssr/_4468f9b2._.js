...
"[project]/app/admin/campaigns/new/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewCampaignPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            let attempt = 1;
            while(attempt <= 10){
                const { data: existing, error: checkError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('campaigns').select('id').eq('slug', uniqueSlug).maybeSingle();
            ...
            const { data, error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('campaigns').insert([
                insertData
            ]).select().single();
            if (insertError) {
...
//# sourceMappingURL=_4468f9b2._.js.map