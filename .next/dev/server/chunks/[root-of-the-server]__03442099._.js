...
"[project]/app/api/email-templates/preview/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const sampleData = {
            ...
            logo_url: `${("TURBOPACK compile-time value", "http://localhost:3000") || 'http://localhost:3000'}/logo-white.png`
        };
        // Replace variables in HTML
        let previewHtml = html_content;
        // Always include logo_url in variables for replacement
        const variablesToReplace = variables && Array.isArray(variables) ? variables.includes('logo_url') ? variables : [
            ...variables,
            'logo_url'
        ] : null;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03442099._.js.map