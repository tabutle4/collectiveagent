...
"[project]/app/admin/agent-roster/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AgentRosterPage() {
    ...
    const [publicLink, setPublicLink] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [scriptsExecuted, setScriptsExecuted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AgentRosterPage.useEffect": ()=>{
            // Load the HTML from the dynamic route (not the static file)
            // Add cache-busting to ensure we get fresh data
            fetch(`/agent-roster.html?t=${Date.now()}`).then({
                "AgentRosterPage.useEffect": (res)=>{
                    if (!res.ok) {
                        throw new Error(`Failed to fetch roster: ${res.statusText}`);
                    }
                    return res.text();
                }
            }["AgentRosterPage.useEffect"]).then({
                "AgentRosterPage.useEffect": (html)=>{
            ...
            padding: 0;
                    ...
                    let scriptContent = '';
                    scripts.forEach({
                        "AgentRosterPage.useEffect": (script)=>{
        ...
        `;
            ...
            }["AgentRosterPage.useEffect"]).catch({
                "AgentRosterPage.useEffect": (error)=>{
        ...
        "AgentRosterPage.useEffect": ()=>{
            ...
            try {
              ...
              console.warn('Roster script execution error:', e);
                ...
                }["AgentRosterPage.useEffect"], 500); // Increased timeout to ensure DOM is ready
            } else {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AgentRosterPage.useEffect": ()=>{
            ...
            window.filterTable = ({
                "AgentRosterPage.useEffect": function() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AgentRosterPage.useEffect": ()=>{
            ...
            const generatePublicLink = {
                "AgentRosterPage.useEffect.generatePublicLink": async ()=>{
                    try {
            ...
            }["AgentRosterPage.useEffect.generatePublicLink"];
            generatePublicLink();
        }
    }["AgentRosterPage.useEffect"], []);
    const exportHTML = ()=>{
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        publicLink && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AgentRosterPage, "+S5FeG1HtYLkJ4Gi5zSjYk5rlVI=");
_c = AgentRosterPage;
var _c;
__turbopack_context__.k.register(_c, "AgentRosterPage");
...
//# sourceMappingURL=app_admin_agent-roster_page_tsx_8bbc0a28._.js.map