...
import {
  BROKERAGE_ROLE_OPTIONS,
  SIDE_OPTIONS,
  FEDERAL_ID_TYPE_OPTIONS as FEDERAL_ID_TYPES,
  PAYMENT_METHOD_OPTIONS as PAYMENT_METHODS,
          ...
          <button onClick={() => setExpanded(e => !e)} className="flex items-center gap-2 text-left w-full">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-luxury-gray-3 truncate">
                {roleLabel}{teb.side ? ` · ${teb.side} side` : ''}{teb.agent_name ? ` · ${teb.agent_name}` : ''}
              </p>
            </div>
          </button>
        </div>
      ...
      {expanded && (
        <div className="mt-3 pt-3 border-t border-luxury-gray-5/50">
          ...
          <div className="mb-3">
            ...
            <FieldRow label="Side" value={teb.side} type="select" options={SIDE_OPTIONS} locked={paid} onSave={v => updateField('side', v || null)} />
