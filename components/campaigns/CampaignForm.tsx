...
export default function CampaignForm({
  ...
  const fetchSavedResponses = async () => {
    try {
      const response = await fetch(
        `/api/campaign/get-responses?token=${token}&campaign_id=${campaignId}`
      )
    ...
    try {
      ...
      if (step.type === 'profile') {
        ...
        const missingFields = requiredFields.filter(
          f => fieldsToCheck.includes(f) && !(profileData as any)[f]
        )
        ...
        const response = await fetch('/api/campaign/update-rsvp', {
          ...
          body: JSON.stringify({
            ...
            rsvp_data: {
              attending_luncheon:
                rsvpData.attending !== null ? rsvpData.attending : rsvpData.attending_luncheon,
  ...
  const handleNext = async () => {
    ...
    if (currentStep === 1) {
      ...
      if (
        ...
        !profileData.preferred_last_name ||
        !profileData.personal_email ||
        !profileData.personal_phone ||
        !profileData.business_phone ||
        !profileData.date_of_birth ||
        !profileData.shirt_type ||
        !profileData.shirt_size ||
        !profileData.shipping_address_line1 ||
        !profileData.shipping_city ||
        !profileData.shipping_state ||
        !profileData.shipping_zip ||
  ...
  const getCommissionPlanDisplay = (plan: string, other?: string) => {
    ...
    if (plan === 'new_agent_plan')
      return 'I have not completed (5) sales within the last 12 months and must remain on the New Agent Plan.'
        ...
        <>
              ...
              <div className="space-y-6 text-base">
                <div>
                  ...
                  {userData.preferred_first_name && (
                    <p className="text-luxury-gray-1 mb-3">Hi, {userData.preferred_first_name}</p>
                  )}
                  <p className="text-luxury-gray-1 mb-2">
                    Your 2025 numbers will reflect closings from{' '}
                    <strong>November 23, 2024 through November 22, 2025</strong>.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-luxury-gray-1">
                    <li>
                      There will be <strong>NO fee, split, or cap increases for 2026!</strong>
                    </li>
                    <li>
                      Your Independent Contractor Agreement remains in effect for an indefinite
                      term. It continues unless you terminate following the{' '}
                      <a
                    ...
                    <li>
                      If you select a new commission plan, you will receive a new agreement to sign
                      reflecting your updated plan.
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-luxury-light p-4 rounded">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-sm text-luxury-gray-1 ml-4">
                    ...
                    <li>
                      Closing date is entered (between November 23, 2024 and November 22, 2025)
                    </li>
                    <li>
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="card-section">
                ...
                <h2 className="text-2xl font-light mb-6 tracking-luxury">Update Your Profile</h2>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onBlur={e =>
                          setProfileData({
                            ...profileData,
                            first_name: formatNameToTitleCase(e.target.value),
                          })
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onBlur={e =>
                          setProfileData({
                            ...profileData,
                            last_name: formatNameToTitleCase(e.target.value),
                          })
                        }
                        className="input-luxury"
                        required
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e =>
                          setProfileData({ ...profileData, preferred_first_name: e.target.value })
                        }
                        onBlur={e =>
                          setProfileData({
                            ...profileData,
                            preferred_first_name: formatNameToTitleCase(e.target.value),
                          })
                        }
                        className="input-luxury"
                        required
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e =>
                          setProfileData({ ...profileData, preferred_last_name: e.target.value })
                        }
                        onBlur={e =>
                          setProfileData({
                            ...profileData,
                            preferred_last_name: formatNameToTitleCase(e.target.value),
                          })
                        }
                        className="input-luxury"
                        required
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e =>
                          setProfileData({ ...profileData, personal_email: e.target.value })
                        }
                        className="input-luxury"
                        required
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e =>
                          setProfileData({ ...profileData, personal_phone: e.target.value })
                        }
                        className="input-luxury"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e =>
                          setProfileData({ ...profileData, business_phone: e.target.value })
                        }
                        className="input-luxury"
                        placeholder="10 digits only"
                        required
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={e =>
                          setProfileData({ ...profileData, shirt_type: e.target.value })
                        }
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={e =>
                          setProfileData({ ...profileData, shirt_size: e.target.value })
                        }
                        className="select-luxury"
                        required
                      >
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={e =>
                            setProfileData({ ...profileData, shipping_zip: e.target.value })
                          }
                          className="input-luxury"
                          required
                        />
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={e =>
                            setProfileData({ ...profileData, instagram_handle: e.target.value })
                          }
                          className="input-luxury"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={e =>
                            setProfileData({ ...profileData, tiktok_handle: e.target.value })
                          }
                          className="input-luxury"
                          placeholder="@username"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={e =>
                            setProfileData({ ...profileData, threads_handle: e.target.value })
                          }
                          className="input-luxury"
                          placeholder="@username"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={e =>
                            setProfileData({ ...profileData, youtube_url: e.target.value })
                          }
                          className="input-luxury"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={e =>
                            setProfileData({ ...profileData, facebook_url: e.target.value })
                          }
                          className="input-luxury"
                        />
                      </div>
                  ...
                  {isAfterDeadline ? (
                    ...
                    <div className="bg-luxury-light p-6 rounded border-l-4 border-luxury-gold">
                      <p className="text-sm text-luxury-gray-2 mb-3">
                        <strong>
                          Commission Plan Deadline Has Passed (
                      ...
                      <p className="text-lg text-luxury-gray-1">
                        {profileData.commission_plan === 'no_cap_plan'
                          ? 'No Cap Plan 85/15'
                          : profileData.commission_plan === 'cap_plan'
                            ? 'Cap Plan 70/30 $18,000 Cap'
                            : profileData.commission_plan === 'no_change'
                              ? 'No Change'
                              : profileData.commission_plan === 'new_agent_plan'
                                ? 'I have not completed (5) sales within the last 12 months and must remain on the New Agent Plan.'
                                : profileData.commission_plan === 'other'
                                  ? `Other: ${profileData.commission_plan_other || 'Not specified'}`
                                  : 'Not yet selected'}
                      </p>
                    ...
                    <>
                      <div className="mb-4">
                        <select
                          ...
                          onChange={e =>
                            setProfileData({ ...profileData, commission_plan: e.target.value })
                          }
                          className="select-luxury"
                          required
                        >
                          ...
                          <option value="70_30_new">
                            New Agent Plan (must remain until 5 sales completed)
                          </option>
                      ...
                      <div className="mt-4 p-4 bg-yellow-50 border-l-4 border-yellow-500 rounded">
                        <p className="text-sm text-yellow-800">
                          <strong>Deadline:</strong> Commission plan selections must be submitted by{' '}
                          {deadlineDate.toLocaleDateString('en-US', {
                            month: 'long',
                            day: 'numeric',
                            year: 'numeric',
                      ...
                      <div className="flex items-center gap-2">
                        <p className="font-medium">
                          {userData.license_expiration
                            ? new Date(userData.license_expiration).toLocaleDateString()
                            : 'N/A'}
                        </p>
                        <a
          ...
          {currentStep === 3 && (
            <div className="card-section">
              ...
              <p className="text-lg italic text-luxury-gray-2 mb-6">We Made It!</p>
              ...
              <div className="bg-luxury-light p-6 rounded mb-6">
                <div className="space-y-3 text-sm">
                  <p>
                    <strong className="text-luxury-gold">Hosted by:</strong> CJE Media
                  </p>
                  <p>
                    <strong className="text-luxury-gold">When:</strong> Tuesday, December 16 at
                    12:00 PM
                  </p>
                  <p>
                    <strong className="text-luxury-gold">Where:</strong> Rhay's Restaurant & Lounge,
                    11920 Westheimer Rd #J, Houston, TX 77077
                  </p>
                  <p>
                    <strong className="text-luxury-gold">RSVP by:</strong> December 9, 2025
                  </p>
                  <p>
                    <strong className="text-luxury-gold">Dress Code:</strong> Black Tie
                  </p>
                </div>
              ...
              <div className="mb-6">
                <label className="block text-sm mb-2 text-luxury-gray-1">Comments (Optional)</label>
                <textarea
              ...
              <p className="text-lg font-medium text-luxury-gold mb-6">Let's Celebrate!</p>
          ...
          {currentStep === 4 && (
            <div className="card-section">
              ...
              <h2 className="text-2xl font-light mb-6 tracking-luxury">Quick Feedback Survey</h2>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <input
                      ...
                      onChange={e =>
                        setSurveyData({ ...surveyData, support_rating: parseInt(e.target.value) })
                      }
                      className="flex-1"
                    />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={e =>
                      setSurveyData({ ...surveyData, support_improvements: e.target.value })
                    }
                    className="textarea-luxury"
                    rows={4}
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center space-x-3 cursor-pointer">
                      <input
                        ...
                        onChange={e =>
                          setSurveyData({ ...surveyData, work_preference: e.target.value })
                        }
                        className="w-4 h-4"
                      />
              ...
              <div className="mt-8 text-center flex justify-center gap-4">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-3 md:px-4 py-2.5 md:py-2 text-xs md:text-sm rounded transition-colors text-center btn-primary md:px-12"
                >
        ...
        <div className="card-section text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-base text-luxury-gray-2 mb-8">
              If you selected a new commission plan, you'll receive your updated agreement via email
              in the coming days. We're grateful for your continued partnership and look forward to
              an amazing 2026 together!
            </p>

            <p className="text-sm text-luxury-gray-2 mb-8">You can close this window now.</p>
