      ...
      {editingCrop && (
        <div className="flex flex-col items-center gap-2">
          ...
          <button
            ...
            disabled={savingCrop}
            className="mt-1 px-3 py-1.5 text-xs rounded transition-colors bg-luxury-black text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1"
          >
            {savingCrop ? (
              <>
