  ...
  return (
    <div>
        ...
        <>
          ...
          <div className="container-card border-l-2 border-luxury-accent mb-4">
            ...
            >
              ...
              <ChevronRight
                size={14}
                className={`text-luxury-gray-3 transition-transform ${outlookTipOpen ? 'rotate-90' : ''}`}
              />
            </button>
            {outlookTipOpen && (
              <div className="mt-2">
                ...
                <div className="flex flex-wrap gap-3 mt-2">
                   ...
                   <a href="https://visit.collectiverealtyco.com/training"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  >
                   ...
                   <a href="https://agent.collectiverealtyco.com/training-center"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xs text-luxury-accent font-semibold hover:underline"
                  >
          ...
          <div className="container-card mb-3">
            <div className="flex items-center justify-between">
              <button
                onClick={prevMonth}
                className="p-2 rounded hover:bg-luxury-light transition-colors"
              >
          ...
          <div className="container-card mb-4 overflow-hidden p-0">
            <div className="grid grid-cols-7 border-b border-luxury-gray-5/30">
              {DAYS.map((d, i) => (
                <div key={i} className="text-center text-xs font-semibold text-luxury-gray-3 py-2">
                  {d}
                </div>
              ))}
            </div>
                  ...
                  return (
                    ...
                    >
                      {day && (
                        <>
                          <span
                            className={`text-xs font-medium inline-flex items-center justify-center w-5 h-5 sm:w-6 sm:h-6 rounded-full mb-0.5 ${isToday(day) ? 'bg-luxury-accent text-white' : 'text-luxury-gray-2'}`}
                          >
                            {day}
                          </span>
                          <div className="space-y-0.5">
                            ...
                            {dayEvents.length > 2 && (
                              <>
                                ...
                                <p className="hidden sm:block text-xs text-luxury-gray-3 pl-1">
                                  +{dayEvents.length - 2}
                                </p>
                              </>
                            )}
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-10 text-center">
                        <p className="text-xs text-luxury-gray-3 leading-none">
                          {new Date(event.start.dateTime || event.start.date).toLocaleDateString(
                            'en-US',
                            { month: 'short' }
                          )}
                        </p>
                        <p className="text-xl font-bold text-luxury-accent leading-tight">
      ...
      {selectedDay && (
        ...
        >
          <div
            className="bg-white rounded-t-2xl w-full max-w-lg shadow-xl flex flex-col max-h-[75vh]"
      ...
      {selectedEvent && (
        ...
        >
          <div
            className="bg-white rounded-t-2xl w-full max-w-lg shadow-xl flex flex-col max-h-[85vh]"
            onClick={e => e.stopPropagation()}
          >
            <div className="flex justify-center pt-3 pb-1 flex-shrink-0">
              <div className="w-10 h-1 rounded-full bg-luxury-gray-4" />
            ...
            <div className="overflow-y-auto px-6 pb-8 pt-2">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1 min-w-0 pr-3">
                  <h3 className="text-base font-semibold text-luxury-gray-1 leading-snug">
                ...
                <button
                  onClick={() => setSelectedEvent(null)}
                  className="flex-shrink-0 p-1 text-luxury-gray-3 hover:text-luxury-gray-1"
                >
                  <X size={18} />
                </button>
              </div>
      ...
      {showForm && isAdmin && (
        ...
        >
          <div
            className="bg-white rounded-t-2xl w-full max-w-lg shadow-xl flex flex-col max-h-[90vh]"
            onClick={e => e.stopPropagation()}
          >
            <div className="flex justify-center pt-3 pb-1 flex-shrink-0">
              <div className="w-10 h-1 rounded-full bg-luxury-gray-4" />
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-luxury-gray-5/30 flex-shrink-0">
              ...
              <button
                onClick={() => setShowForm(false)}
                className="text-luxury-gray-3 hover:text-luxury-gray-1 p-1"
              >
                <X size={18} />
              </button>
            </div>
            <div className="overflow-y-auto px-6 py-4 space-y-3 flex-1">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="rounded"
                />
                <label htmlFor="allday" className="text-xs text-luxury-gray-2">
                  All day
                </label>
              </div>
              {!form.isAllDay && (
