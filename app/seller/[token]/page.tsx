...
import {
  ListingCoordination,
  Listing,
  CoordinationWeeklyReport,
} from '@/types/listing-coordination'
      ...
      <div className="min-h-screen bg-luxury-light pt-24 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="container-card mb-5">
            <h2 className="text-xl font-light mb-4">Welcome, {coordination.seller_name}!</h2>
            <p className="text-sm text-luxury-gray-1">
              This is your personal dashboard for tracking the marketing and activity of your
              listing at {listing.property_address}. You'll receive weekly email updates every
              Monday evening with the latest reports.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="container-card">
              <h3 className="text-xs text-luxury-gray-3 uppercase tracking-wider mb-3">
                Your Listing Agent
              </h3>
              {agentInfo ? (
                <>
                  ...
                  {agentInfo.phone && (
                    <p className="text-sm text-luxury-gray-2">
                      <a
                        href={`tel:${agentInfo.phone.replace(/\D/g, '')}`}
            ...
            <div className="container-card">
              ...
              <p className="text-sm text-luxury-gray-2 mb-1">
                <a
                  href="mailto:transactions@collectiverealtyco.com"
                  className="hover:text-luxury-black"
                >
