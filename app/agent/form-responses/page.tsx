            ...
            <div className="p-6 space-y-6">
              ...
              <div className="border-t border-luxury-gray-5 pt-6 mt-6">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm rounded transition-colors bg-luxury-black text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
