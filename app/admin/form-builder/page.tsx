        ...
        <div className="max-w-4xl mx-auto">
          <div className="card-section text-center py-12">
            ...
            <button
              ...
              className="mt-4 px-4 py-2 text-sm rounded transition-colors bg-luxury-black text-white hover:opacity-90"
            >
              Back to Forms
            </button>
          </div>
        ...
        <div className="card-section">
          ...
          <div className="mt-6 pt-6 border-t border-luxury-gray-5 flex justify-end">
            <button
              ...
              className="px-6 py-2.5 text-sm rounded transition-colors bg-luxury-black text-white hover:opacity-90 disabled:opacity-50 flex items-center gap-2"
            >
