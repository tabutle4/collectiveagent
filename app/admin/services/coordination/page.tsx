...
export default function CoordinationServiceConfig() {
  ...
  const moveInclusion = (index: number, direction: 'up' | 'down') => {
    ...
    if (newIndex >= 0 && newIndex < newInclusions.length) {
      ;[newInclusions[index], newInclusions[newIndex]] = [
        newInclusions[newIndex],
        newInclusions[index],
      ]
      ...
      <div className="max-w-4xl mx-auto">
        <div className="container-card">
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-sm mb-2 text-luxury-gray-1">Service Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm mb-2 text-luxury-gray-1">Service Description</label>
              <textarea
            ...
            <div>
              <label className="block text-sm mb-2 text-luxury-gray-1">Price ($)</label>
              <input
                type="number"
                step="0.01"
            ...
            <div>
              <label className="block text-sm mb-2 text-luxury-gray-1">Payment Terms</label>
              <textarea
            ...
            <div>
              ...
              <div className="space-y-2 mb-3">
                {formData.inclusions.map((inclusion, index) => (
                  <div
                    key={index}
                    className="flex items-center space-x-2 bg-luxury-light p-3 rounded"
                  >
            ...
            <div className="border-t border-luxury-gray-5 pt-6">
              ...
              <div className="bg-luxury-light p-4 rounded">
                <p className="font-medium text-base mb-1">
                  {formData.service_name} - ${formData.price}{' '}
                  <span className="text-xs font-normal text-luxury-gray-2">(one time)</span>
                </p>
                {formData.payment_terms && (
                  <p className="text-xs text-luxury-gray-2 mb-2">{formData.payment_terms}</p>
                )}
