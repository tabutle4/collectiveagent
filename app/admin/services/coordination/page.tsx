                ...
                {formData.inclusions.map((inclusion, index) => (
                  <div key={index} className="flex items-center space-x-2 bg-luxury-light p-3 rounded">
                    ...
                    <button
                      ...
                      disabled={index === 0}
                      className="px-2 py-1 text-xs rounded transition-colors bg-white border border-luxury-gray-5 text-luxury-gray-1 hover:border-luxury-black disabled:opacity-30"
                    >
                      ↑
                    </button>
                    <button
