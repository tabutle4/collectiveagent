  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-5 md:mb-8 gap-4">
        ...
        <Link href="/admin/campaigns/builder" className="px-2.5 md:px-4 py-2 text-xs md:text-sm rounded transition-colors text-center bg-luxury-black text-white hover:opacity-90 w-full md:w-auto inline-block">
          Create New Campaign
        </Link>
      </div>
      ...
      {campaigns.length === 0 ? (
        <div className="card-section text-center py-12">
          ...
          <Link href="/admin/campaigns/builder" className="px-2.5 md:px-4 py-2 text-xs md:text-sm rounded transition-colors text-center bg-luxury-black text-white hover:opacity-90 inline-block">
