...
export async function GET(request: NextRequest) {
  try {
    ...
    const defaultSettings = {
      ...
      website: 'https://coachingbrokerage.com',
      // Office Locations (for email signature)
      houston_address_line1: '13201 Northwest Fwy',
      houston_address_line2: 'Ste 450',
      houston_city: 'Houston',
      houston_state: 'TX',
      houston_zip: '77040',
      houston_phone: '(281) 638-9407',
      houston_fax: '(281) 516-5806',
      dfw_address_line1: '2300 Valley View Ln',
      dfw_address_line2: 'Ste 518',
      dfw_city: 'Irving',
      dfw_state: 'TX',
      dfw_zip: '75062',
      dfw_phone: '',
      dfw_fax: '',
      rc_brand_name: 'Referral Collective',
      rc_address_line1: '13201 Northwest Fwy',
      rc_address_line2: 'Ste 450',
      rc_city: 'Houston',
      rc_state: 'TX',
      rc_zip: '77040',
      rc_phone: '(281) 638-9407',
      rc_fax: '',
      rc_logo_url: 'https://zuhqqtfnyjlvbpcprdhf.supabase.co/storage/v1/object/public/public-assets/The%20Coaching%20Brokerage%20Final-01%20(1).png',
      rc_website: 'https://coachingbrokerage.com',
      // Standard Agent
